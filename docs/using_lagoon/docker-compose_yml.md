...
You can also overwrite the templates only for a specific environment. This is done in [`.lagoon.yml`](lagoon_yml.md#environmentsnamerollouts)
...
You can also overwrite the rollout for just one specific environment. This is done in [`.lagoon.yml`](lagoon_yml.md#environmentsnamerollouts)
